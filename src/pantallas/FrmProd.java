...
public class FrmProd extends javax.swing.JFrame {
    ...
    ArrayList<Report> reportes = new ArrayList<>();
    ...
    public FrmProd() {
        ...
        ThClienteProds hilo = new ThClienteProds(sc,in,this);
        hilo.start();
    }
    ...
    private void llenarTablaSeleccionadas() {
        List<Producto> listaProductos = prods;
    ...
    public void agregarReporte(Report rep) {
    ...
    private void llenarTablaSeleccionadasReportes() {
        List<Report> listaReportes = reportes;
        ...
        listaReportes.forEach(reportes -> {
            Object[] fila = new Object[2];
            fila[0] = reportes.getProd().getName();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        prod.setName(txtNombre.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      Producto prod = getNombreZonaSeleccionado();
        ...
        try {
            ...
            out.writeUTF(prodJson); //Envia el mensaje
            out.flush();
